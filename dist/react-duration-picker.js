(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["react-duration-picker"] = factory(require("react"));
	else
		root["react-duration-picker"] = factory(root["React"]);
...
var DurationPicker = function (_Component) {
  ...
  function DurationPicker(props) {
    ...
    _this.translate = function (key) {
      return _this.props.translations[key];
    };
    ...
    _this.updateState = function (value) {
      ...
      _this.setState({ value: value, days: days, hours: hours, minutes: minutes, seconds: seconds });
      _this.props.onChange(value);
    };

    _this.state = { value: 0, days: 0, hours: 0, minutes: 0, seconds: 0 };
    return _this;
  }

  _createClass(DurationPicker, [{
    key: 'buildDisplayBlock',
    value: function buildDisplayBlock(key, max) {
      return _react2.default.createElement(
        'div',
        { className: 'bdp-block' },
        _react2.default.createElement('input', { className: 'form-control input-sm', type: 'number', min: '0', value: '0', max: max }),
...
DurationPicker.propTypes = {
  ...
  showDays: _propTypes2.default.bool
};
...
exports.DurationPicker = undefined;

var _DurationPicker = __webpack_require__(4);

var _DurationPicker2 = _interopRequireDefault(_DurationPicker);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.DurationPicker = _DurationPicker2.default;
